...
public class V1ApiController implements V1Api {
	...
	@Autowired
	V1Bian3CorePayment1000UpdatepaymentPostI v1Bian3CorePayment1000UpdatepaymentPostI;
    ...
    public ResponseEntity<Void> v1Bian3CorePayment1000UpdatepaymentPost(@ApiParam(value = "" ,required=true )  @Valid @RequestBody Updatepayment updatepayment){
        V1Bian3CorePayment1000UpdatepaymentPostResponseWrapper res=null;
        try {
             res  = v1Bian3CorePayment1000UpdatepaymentPostI.execute(new V1Bian3CorePayment1000UpdatepaymentPostP(updatepayment));
        } catch (Exception e) {
            // TODO Exception handling
             return new ResponseEntity<>(res.getResponse(),res.getHeaders(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
